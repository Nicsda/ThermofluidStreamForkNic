...
equation
  ...
  h_out = h_in;
  Xi_out = Xi_in;
  assert(noEvent(m_flow > 0 and Re > 3.3e3 or m_flow < 0 and Re > 1e4), "Reynolds number is below valid flow regime. Simulation results might be incorrect!", AssertionLevel.warning);
  annotation (
