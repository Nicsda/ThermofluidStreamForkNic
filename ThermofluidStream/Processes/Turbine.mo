...
equation
  // test for ideal gas
  assert(noEvent(abs(R_in- R_in)/R_in < max_rel_R), "In \"" + instanceName + "\": Medium in turbine is assumed to be ideal gas, but check failed", dropOfCommons.assertionLevel);
