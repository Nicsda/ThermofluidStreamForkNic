...
equation
  ...
  assert(noEvent(abs(v_in- v_out)/v_in < max_rel_volume), "In \"" + instanceName + "\": Medium in pump is assumed to be incompressible, but check failed", dropOfCommons.assertionLevel);
